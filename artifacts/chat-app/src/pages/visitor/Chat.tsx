...
import { Send, Image, ArrowLeft, Wifi, WifiOff, RefreshCw } from "lucide-react";
    ...
    <>
      <div className={`flex ${isOwn ? "justify-end" : "justify-start"} mb-3`}>
        <div className={`max-w-[75%] ${isOwn ? "items-end" : "items-start"} flex flex-col`}>
          {!isOwn && (
            <span className="text-xs text-muted-foreground mb-1 ml-1 font-medium">Support</span>
          )}
          <div
    ...
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="flex items-center gap-3 px-4 py-3 bg-card border-b border-border shadow-sm">
        ...
        <div className="flex-1">
          <h1 className="font-semibold text-foreground text-sm">Customer Support</h1>
        ...
        {messages.length === 0 && (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1">Our team will respond shortly</p>
            </div>
          </div>
        )}
        {messages.map((msg) => (
